...
<div class="container container-vagas">
    ...
    <?php 
        ...
        <?php
            if($qtd > 0) { 
                ...
                while ($row = $res->fetch_object()){ 
                    ...
                    print '<div class="" data-id='.$id_table.'>
                            ...
                            <div class="card">
                                ...
                                <div class="botoes-vagas">
                                    <div class="btn-editar-vaga">
                                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#editarModalVagas">EDITAR</button> 
                                    </div>
        ...
        ?>
            ...
            <!-- MODAL PARA EDITAR -->
            <div class="modal fade exampleModalCenter" id="editarModalVagas" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
